...
class msg_isdlock():
    ...
    def __init__(self, nVersion=0, inputs=[], txid=0, cycleHash=0, sig=b'\\x0' * 96):
    ...
    def __repr__(self):
        return "msg_islock(nVersion=%d, inputs=%s, txid=%064x, cycleHash=%064x)" % (self.nVersion, repr(self.inputs), self.txid, self.cycleHash)
